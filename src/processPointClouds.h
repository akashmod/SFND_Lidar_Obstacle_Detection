...
public:
    ...
    void Proximity(std::vector<std::vector<float>>& points, int id, std::vector<int>* cluster, KdTree* tree, float distanceTol, std::vector<int> &processedPoints);
    ...
    class cBox1: public pcl::CropBox<PointT> {};
};
